        ...
        return [
            {
                ...
                "orderItems": [
                    {"name": "Gold nugget", "quantity": 30, "category": "Materials"},
                    {"name": "Iron nugget", "quantity": 30, "category": "Materials"},
                    {"name": "Nook Miles Ticket", "quantity": 10, "category": "Tools/Goods"},
                    {"name": "Wood", "quantity": 30, "category": "Materials"},
                ],
            },
            {
                ...
                "category": "Tools",
                "description": "Complete set of unbreakable Golden Tools.",
                "orderItems": [
                    {"name": "Golden axe", "quantity": 1, "category": "Tools/Goods"},
                    {"name": "Golden shovel", "quantity": 1, "category": "Tools/Goods"},
                    {"name": "Golden net", "quantity": 1, "category": "Tools/Goods"},
                    {"name": "Golden fishing rod", "quantity": 1, "category": "Tools/Goods"},
                    {"name": "Golden watering can", "quantity": 1, "category": "Tools/Goods"},
                    {"name": "Golden slingshot", "quantity": 1, "category": "Tools/Goods"},
                ],
            },
        ]
