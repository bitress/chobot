...
def init_dashboard_db():
    ...
    try:
        ...
        # Seed initial official bundles if table is empty
        try:
            count_row = conn.execute("SELECT COUNT(*) FROM pocket_bundles").fetchone()
            ...
            if count == 0:
                ...
                initial_bundles = [
                    (
                        "max-wealth",
                        "Max Wealth Bundle",
                        "20 Royal Crowns + 20 Nook Miles Tickets for instant max bells and miles trading.",
                        "Wealth",
                        "fa-crown",
                        1,
                        "System",
                        json.dumps([
                            {"id": "14BB", "name": "Royal Crown", "commandId": "14BB", "quantity": 20, "icon": "https://dodo.ac/np/images/c/c7/Royal_Crown_NH_Storage_Icon.png"},
                            {"id": "16DB", "name": "Nook Miles Ticket", "commandId": "16DB", "quantity": 20, "icon": "https://dodo.ac/np/images/4/43/Nook_Miles_Ticket_NH_Inv_Icon.png"}
                        ]),
                        json.dumps([
                            {"id": "14BB", "name": "Royal Crown", "commandId": "14BB", "quantity": 5, "icon": "https://dodo.ac/np/images/c/c7/Royal_Crown_NH_Storage_Icon.png"},
                            {"id": "16DB", "name": "Nook Miles Ticket", "commandId": "16DB", "quantity": 4, "icon": "https://dodo.ac/np/images/4/43/Nook_Miles_Ticket_NH_Inv_Icon.png"}
                        ]),
                        now_iso,
                        now_iso
                    ),
                    (
                        "golden-tools",
                        "Golden Tools & Rare Vault",
                        "All 6 Golden Tools + 10x Stacks of Gold Nuggets, Iron, and Star Fragments.",
                        "Tools & Materials",
                        "fa-hammer",
                        1,
                        "System",
                        json.dumps([
                            {"id": "0A80", "name": "Golden Axe", "commandId": "0A80", "quantity": 1},
                            {"id": "0A81", "name": "Golden Shovel", "commandId": "0A81", "quantity": 1},
                            {"id": "0A82", "name": "Golden Fishing Rod", "commandId": "0A82", "quantity": 1},
                            {"id": "0A83", "name": "Golden Net", "commandId": "0A83", "quantity": 1},
                            {"id": "0A84", "name": "Golden Watering Can", "commandId": "0A84", "quantity": 1},
                            {"id": "0A85", "name": "Golden Slingshot", "commandId": "0A85", "quantity": 1},
                            {"id": "0BCA", "name": "Gold Nugget", "commandId": "0BCA", "quantity": 10},
                            {"id": "0BC9", "name": "Iron Nugget", "commandId": "0BC9", "quantity": 12},
                            {"id": "1AEB", "name": "Star Fragment", "commandId": "1AEB", "quantity": 12}
                        ]),
                        json.dumps([]),
                        now_iso,
                        now_iso
                    ...
                    (
                        "museum-art",
                        "Museum Art Masterpiece",
                        "Full pocket of verified genuine statues and iconic art.",
                        "Popular",
                        "fa-palette",
                        1,
                        "System",
                        json.dumps([
                            {"id": "1198", "name": "Valiant Statue (Real)", "commandId": "1198", "quantity": 5},
                            {"id": "1199", "name": "Gallant Statue (Real)", "commandId": "1199", "quantity": 5},
                            {"id": "119A", "name": "Robust Statue (Real)", "commandId": "119A", "quantity": 5},
                            {"id": "119B", "name": "Familiar Statue (Real)", "commandId": "119B", "quantity": 5},
                            {"id": "119C", "name": "Great Statue (Real)", "commandId": "119C", "quantity": 5},
                            {"id": "118E", "name": "Academic Painting (Real)", "commandId": "118E", "quantity": 5},
                            {"id": "118F", "name": "Amazing Painting (Real)", "commandId": "118F", "quantity": 5},
                            {"id": "1190", "name": "Calm Painting (Real)", "commandId": "1190", "quantity": 5}
                        ]),
                        json.dumps([]),
                        now_iso,
                        now_iso
                    ...
                    (
                        ...
                        "All Cherry-Blossom DIY recipe cards + stacks of fresh Cherry-Blossom Petals.",
                        "Seasonal",
                        "fa-fan",
                        1,
                        "System",
                        json.dumps([
                            {"id": "1BA3", "name": "Cherry-Blossom Petal", "commandId": "1BA3", "quantity": 20},
                            {"id": "0D4E", "name": "Cherry-Blossom Branches", "commandId": "0D4E", "quantity": 5},
                            {"id": "0D4F", "name": "Blossom-Viewing Lantern", "commandId": "0D4F", "quantity": 5},
                            {"id": "0D50", "name": "Cherry-Blossom Bonsai", "commandId": "0D50", "quantity": 5},
                            {"id": "0D51", "name": "Outdoor Picnic Set", "commandId": "0D51", "quantity": 5}
                        ]),
                        json.dumps([]),
                        now_iso,
                        now_iso
                ...
                for b in initial_bundles:
                    conn.execute("""
                        INSERT OR IGNORE INTO pocket_bundles
